...
Revision ID: 9488b1a3a165
Revises: 91808b8a2ea8
Create Date: 2020-03-29 03:19:15.164273
...
revision = '9488b1a3a165'
down_revision = '91808b8a2ea8'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['subject'], ['department.name'], name='class_subject_fkey'),
