...
Revision ID: 233ada81cc9d
Revises: 763ca667f505
Create Date: 2020-03-29 01:29:16.240985
...
revision = '233ada81cc9d'
down_revision = '763ca667f505'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['main_subject', 'main_num'], ['class.subject', 'class.num'], ),
    sa.ForeignKeyConstraint(['sup_subject', 'sup_num'], ['class.subject', 'class.num'], ),
